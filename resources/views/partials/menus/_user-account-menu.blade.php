...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="symbol symbol-50px me-5">
                @if (Auth::user()->getConvertedImage())
                    <img alt="Logo" src="{{ Auth::user()->getConvertedImage() }}" />
                @else
                    <div
    ...
    <div class="menu-item px-5">
        <a href="{{ route('user-management.users.edit', Auth::user()) }}" class="menu-link px-5">My Profile</a>
    </div>
    <!--end::Menu item-->
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{ route('projects.index') }}" class="menu-link px-5">
            ...
            <span class="menu-badge">
                <span class="badge badge-light-danger badge-circle fw-bold fs-7"> {{ App\Models\Project::count() }}
                </span>
            </span>
        </a>
    </div>
