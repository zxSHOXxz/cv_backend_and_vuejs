...
class ExperienceDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (Experience $experience) {
                return view('pages/apps.experience.columns._actions', compact('experience'));
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(2)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/experience/columns/_draw-scripts.js')) . "}");
    }
