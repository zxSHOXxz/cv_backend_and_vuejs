...
class SkillsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (Skill $skill) {
                return view('pages/apps.skills.columns._actions', compact('skill'));
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(2)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/skills/columns/_draw-scripts.js')) . "}");
    }
