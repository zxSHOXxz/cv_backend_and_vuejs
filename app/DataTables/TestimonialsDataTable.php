...
class TestimonialsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->editColumn('name', function (Testimonial $testimonial) {
                return view('pages/apps.testimonials.columns._testimonial', compact('testimonial'));
            })
            ->addColumn('action', function (Testimonial $testimonial) {
                return view('pages/apps.testimonials.columns._actions', compact('testimonial'));
            })
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(2)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/testimonials/columns/_draw-scripts.js')) . "}");
    }
